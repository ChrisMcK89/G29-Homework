...
class TestCaraoke(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.guest1 = Guest("Chris", 10, self.song2.title)
        self.guest2 = Guest("Rory", 15, self.song1.title)
        self.guest3 = Guest("Callum", 20, self.song3.title)
        
        self.room1 = Room("Room1", 2, 5)
        self.room2 = Room("Room2", 4, 7)
        self.room3 = Room("Room3", 6, 10)
        self.room4 = Room("Room4", 10, 15)
    ...
    def test_guest_has_fav_song(self):
        self.assertEqual("Yellow", self.guest1.fav_song)
